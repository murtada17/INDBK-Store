...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row">
          ...
          <div class="col-6 col-md-2"></div>
       <div class="col-6 col-md-2">
            <asp:Label ID="Label2" runat="server" Text="رمز المرور : "></asp:Label>
        </div>
        <div class="col-6 col-md-2">
    ...
    <div class="row">
          <div class="col-6 col-md-2"></div>
        <div class="col-6 col-md-2"></div>
            <div class="col-6 col-md-2">     <asp:Button style="font-size: unset;" ID="btnLogin" runat="server" Text="تسجيل الدخول" width="100%" CssClass="btn btn-success" OnClick="btnLogin_Click" /></div>
                <div class="col-6 col-md-2">   <asp:Button style="font-size: unset;" ID="btnCancel" runat="server" Text="ألغاء" width="100%" CssClass="btn btn-danger" OnClick="btnCancel_Click" />
    </div></div>
        <div class="col-6 col-md-2"></div>
     <div class="col-6 col-md-2"></div>
       </div> 
