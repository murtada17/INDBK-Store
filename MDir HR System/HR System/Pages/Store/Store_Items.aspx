<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MDirMaster.Master" AutoEventWireup="true" CodeBehind="Store_Items.aspx.cs" Inherits="HR_Salaries.Pages.Store.Store_Items" %>
                ...
                <div class="sub-content">
                    <div class="list-group">
                            ...
                            <asp:Panel ID="PalChose" runat="server">
                                <div class="row">
                                    <div class="col-6 col-md-12">
                                        <asp:Label CssClass="lbl" Width="100%" ID="Label4" runat="server" Text="المعلومات"></asp:Label>
                                    </div>
                                </div>
                            </asp:Panel>
                        ...
                        <div dir="rtl">
                              ...
                              <asp:Label Width="100%" ID="lbl" runat="server" Text=""></asp:Label>
                            ...
                            <div class="row">
                                 <div class="col-6 col-md-3">
                                    <asp:Label CssClass="lbl" Width="100%" ID="Label1" runat="server" Text="أسم المادة" ></asp:Label>
                                        ...
                                        <div class="col-6 col-md-6">
                                            <asp:TextBox ID="item_name" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                        </div>
                               </div>
