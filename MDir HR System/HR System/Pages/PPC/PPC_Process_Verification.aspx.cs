...
{
    public partial class PPC_Process_Verification : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (branch_ == "46")
                {
                    ...
                    cmd_Search.CommandText = @"SELECT Pro.[id]
                              ...
                              where [Verification_status] = 0 and [Process_Type] = 3 and [user_update] in (1015,1016,1022)";
                ...
                else
                {
                     ...
                     SqlCommand cmd_Search = new SqlCommand();
                             ...
                             where [Verification_status] = 0 and [Process_Type] in (1,2,3,4) and [user_update] not in (1015,1016)";
