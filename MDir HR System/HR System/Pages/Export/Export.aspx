                    ...
                    <div class="sub-content">
                        <div class="list-group">
                            ...
                            <asp:Button style="font-size: unset;" ID="btnAlExport_out" Width="100%" CssClass="btn btn-success" runat="server" Text="Al CSV Export OUT" OnClick="btnAlExport_OUT_Click" Visible="false" />
                                ...
                                <div class="col-6 col-md-3">
                                    <asp:Button style="font-size: unset;" ID="btnADExport" Width="100%" CssClass="btn btn-success" runat="server" Text="AD CSV Export" OnClick="btnADExport_Click" />
                                </div>
                                <div class="col-6 col-md-3">
...
<div class="col-6 col-md-3">
                ...
                <div class="col-6 col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3">
                                <asp:TextBox CssClass="txt" Width="100%" ID="txtDSlipNu" runat="server" Enabled="False"></asp:TextBox>
                            </div>
                            <div class="col-6 col-md-3">
